...
import { ArrowUpDown, Calendar, DollarSign, Eye, Car, QrCode, Brain } from "lucide-react";
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            {/* NEW: AI Intelligence column header */}
            <TableHead className="w-[120px]">
              <Button 
                variant="ghost" 
                size="sm" 
                onClick={() => onSort('hotness')}
                className="flex items-center space-x-1 hover:bg-transparent p-0 h-auto font-medium"
              >
