...
const OptimizedConsolidatedSmartInbox = () => {
  console.log('🚫 [OPTIMIZED CONSOLIDATED SMART INBOX] This component is disabled - use MobileSmartInbox instead');
  
  return (
    <div className="flex items-center justify-center h-full p-8">
      <div className="text-center">
        <div className="text-lg font-medium text-gray-700 mb-2">
          Optimized Consolidated Smart Inbox Disabled
        </div>
