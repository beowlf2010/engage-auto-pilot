...
import MarkSoldConfirmDialog from '../leads/MarkSoldConfirmDialog';
import { updateVehicleInterest, updateAIFollowupLevel } from '@/services/vehicleUpdateService';
import { markLeadAsSold } from '@/services/leadStatusService';
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: `${conversation.leadName} has been marked as sold and removed from all automation.`,
        });
        
        // Refresh the page after successful marking
        setTimeout(() => window.location.reload(), 1000);
      } else {
        toast({
          title: "Error",
    ...
    <>
      <div className="space-y-6">
        ...
        <LeadActionsSection
          ...
          onMarkAsSold={() => setShowMarkSoldDialog(true)}
