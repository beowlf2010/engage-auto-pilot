-- ============================================
-- STREAMLINED ROLE MANAGEMENT SYSTEM
-- ============================================
...
-- 10. RLS policy for user_roles_view
CREATE POLICY "Users can view role information" ON public.user_roles
FOR SELECT TO authenticated
USING (
  user_id = auth.uid() OR 
  user_has_manager_access(auth.uid())
);