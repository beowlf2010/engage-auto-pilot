...
-- Fix v_monthly_retail_summary view (corrected column reference)
...
SELECT 
  ...
  SUM(CASE WHEN deal_type = 'retail' THEN 1 ELSE 0 END) as retail_units,
  SUM(CASE WHEN deal_type = 'retail' THEN total_profit ELSE 0 END) as retail_gross,
  SUM(CASE WHEN deal_type = 'dealer_trade' THEN 1 ELSE 0 END) as dealer_trade_units,
  SUM(CASE WHEN deal_type = 'dealer_trade' THEN total_profit ELSE 0 END) as dealer_trade_gross,
  SUM(CASE WHEN deal_type = 'wholesale' THEN 1 ELSE 0 END) as wholesale_units,
  SUM(CASE WHEN deal_type = 'wholesale' THEN total_profit ELSE 0 END) as wholesale_gross,
