-- Emergency data purge for dealership change
-- This will completely wipe all existing lead data and reset for U-J Chevrolet

BEGIN;

-- Step 1: Create or update anonymous lead for conversation preservation
INSERT INTO public.leads (
  ...
  now(), 
  now()
) ON CONFLICT (source) WHERE source = 'anonymized_system' 
  DO UPDATE SET 
    id = '00000000-0000-0000-0000-000000000001'::uuid,
    updated_at = now();

-- Step 2: Reassign all conversations to anonymous lead
UPDATE public.conversations 
SET lead_id = '00000000-0000-0000-0000-000000000001'::uuid 
WHERE lead_id != '00000000-0000-0000-0000-000000000001'::uuid;

-- Step 3: Delete all AI and related data for non-anonymous leads
...
-- Step 4: Delete all non-anonymous leads
DELETE FROM public.leads 
WHERE id != '00000000-0000-0000-0000-000000000001'::uuid;

-- Step 5: Delete all inventory
DELETE FROM public.inventory;

-- Step 6: Delete all upload history
DELETE FROM public.upload_history;

-- Step 7: Update dealership settings
