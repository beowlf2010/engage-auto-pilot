-- Fix column name mismatches in insert_inventory_with_context function
  ...
  LOOP
    ...
    EXCEPTION WHEN OTHERS THEN
      ...
      errors := errors || jsonb_build_object(
        ...
        'column_issue', 'Check column name mappings - common issues: invoice_price->invoice, color_exterior->exterior_color, color_interior->interior_color, vehicle_description->description'
      );
    END;
  END LOOP;
