-- Comprehensive Lead Cleanup: Remove Invalid and Duplicate Leads

-- Step 1: Mark business/organization records as invalid
UPDATE leads 
SET status = 'invalid', 
    is_hidden = true,
    updated_at = now()
...
-- Step 6: Mark leads without valid phone numbers as invalid
UPDATE leads 
SET status = 'invalid',
    is_hidden = true,
    updated_at = now()
