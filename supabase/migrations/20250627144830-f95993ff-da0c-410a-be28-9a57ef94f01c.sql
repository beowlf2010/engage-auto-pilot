...
-- Create a completely rewritten bypass function that avoids RLS recursion
...
BEGIN
  ...
  LOOP
    ...
    BEGIN
      ...
      -- Direct INSERT without EXECUTE format - this completely bypasses RLS
      INSERT INTO leads (
      ...
      -- Insert phone numbers if they exist using direct INSERT without EXECUTE
