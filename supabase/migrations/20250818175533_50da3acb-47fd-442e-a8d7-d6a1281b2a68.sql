-- Update purge function to work with direct user ID parameter
CREATE OR REPLACE FUNCTION public.purge_all_leads_as_admin(p_user_id uuid, p_dry_run boolean DEFAULT true)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
