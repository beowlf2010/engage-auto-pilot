...
-- Create indexes for performance (removed problematic WHERE clauses)
...
CREATE INDEX idx_ai_insights_actionable ON public.ai_insights(actionable);
CREATE INDEX idx_inventory_predictions_type ON public.inventory_predictions(prediction_type);
CREATE INDEX idx_inventory_predictions_valid ON public.inventory_predictions(valid_until);
